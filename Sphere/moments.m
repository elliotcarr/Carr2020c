function moment = moments(R,D,configuration,dim,start_pos,moment_choice)
% Computes the closed-form expressions for the moments of the exit time
% distribution for the heterogeneous sphere.
% OUTPUTS:
...
% configuration - string 'outward' or 'inward' indicating the configuration of 
%   the exit boundary
